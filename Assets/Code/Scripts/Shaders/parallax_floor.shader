Shader "Ozeg/parallax_floor"
{
    Properties
    {
        ...
        _ShadowDepth ("Shadow Depth", Float) = 0
    }
    SubShader
    {
        ...
        sampler2D _MainTex, _RCSMTex, _SurfaceTex, _EmissionTex;
        float4 _MainTex_ST, _RCSMTex_ST, _EmissionTex_ST;
        float _Depth;
        ...
        float _Glossiness, _Metallic, _Occlusion, _NormalDepth, _Bias, _ShadowDepth, _EmissionOffset;
        ...
        void surf (Input i, inout SurfaceOutputStandard o)
        {
            ...
            o.Occlusion = 1.-_Occlusion*(1-surf.b)*(1-emissionMask);
            o.Alpha = c.a;
        }
        ENDCG
    }
